...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = Emps.Where
        ...
        public static IEnumerable<object> ExplanationForMyself()
        {
            IEnumerable<object> result = Emps.GroupBy(emp => emp.Job)
                .Select(g => new
                {
                    Job = g.Key,
                    // Here "g" is treated as a collection(groups of emps based on their Job), then we iterate over each collection Summing the salaries
        ...
        public static IEnumerable<object> Task10()
        {
            ...
            {
                Ename = "Brak wartości",
                // need to cast it to a string, else there'd be a NullReferenceException
                Job = (string)null,
                // using a "nullable type", for obvious reasons
